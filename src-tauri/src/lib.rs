...
pub fn run() {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::change_transcription_mode,
        shortcut::set_stt_provider,
        shortcut::change_stt_api_key,
        shortcut::change_stt_model,
        shortcut::change_stt_base_url,
