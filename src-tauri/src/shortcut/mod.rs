...
use crate::settings::{
    ...
    PasteMethod, ShortcutBinding, SoundTheme, TranscriptionMode, APPLE_INTELLIGENCE_DEFAULT_MODEL_ID,
...
// ============================================================================
// Online STT Settings Commands
// ============================================================================

#[tauri::command]
#[specta::specta]
pub fn change_transcription_mode(app: AppHandle, mode: TranscriptionMode) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
...
pub fn change_stt_base_url(
    ...
    if !provider.allow_base_url_edit {
        return Err(format!(
            "STT provider '{}' does not allow editing the base URL",
            provider.label
        ));
    }
    provider.base_url = base_url;
